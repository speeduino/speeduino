...
static void test_tableLookup_exact1Axis(void)
{
  ...
  uint16_t tempVE = get3DTableValue(&testTable, 48, testTable.axisX.axis[6]*axis_domain_to_factor(testTable.XDomain)); //Perform lookup into fuel map for RPM vs MAP value
...
static void test_tableLookup_exact2Axis(void)
{
  ...
  uint16_t tempVE = get3DTableValue(&testTable, testTable.axisY.axis[5]*axis_domain_to_factor(testTable.YDomain), testTable.axisX.axis[7]*axis_domain_to_factor(testTable.XDomain)); //Perform lookup into fuel map for RPM vs MAP value
...
static void test_tableLookup_overMaxX(void)
{
  ...
  uint16_t tempVE = get3DTableValue(&testTable, 73, getXMax(testTable)+100); //Perform lookup into fuel map for RPM vs MAP value
...
static void test_tableLookup_overMaxY(void)
{
  ...
  uint16_t tempVE = get3DTableValue(&testTable, getYMax(testTable)+10, 600); //Perform lookup into fuel map for RPM vs MAP value
...
static void test_tableLookup_underMinX(void)
{
  ...
  uint16_t tempVE = get3DTableValue(&testTable, 38, getXMin(testTable)-100); //Perform lookup into fuel map for RPM vs MAP value
...
static void test_tableLookup_underMinY(void)
{
  ...
  uint16_t tempVE = get3DTableValue(&testTable, getYMin(testTable)-5, 600); //Perform lookup into fuel map for RPM vs MAP value
...
static void test_all_incrementing(void)
{
  ...
  for(uint16_t rpm = 0; rpm<getXMax(testTable)+1000; rpm+=100)
  {
    tempVE = 0;
    for(uint8_t load = 0; load<getYMax(testTable)+10; load++)
    {
