...
extern void SetRevolutionTime(uint32_t revTime, uint16_t degreesOver);
...
void setEngineSpeed(uint16_t rpm, int16_t max_crank) {
    SetRevolutionTime( (60UL*1000000UL) / rpm, 360U);
...
void test_calc_ign_timeout_360()
{
    ...
    TEST_ASSERT_EQUAL(787, degreesPerMicro1x15);    
    TEST_ASSERT_EQUAL(10667, timePerDegree24x8);
...
void test_calc_ign_timeout_720()
{
    ...
    static const ign_test_parameters test_data[] PROGMEM = {
        ...
        { 0, 40, 0, 24334, 24334, 584, 680 },
        { 0, 40, 45, 22459, 22459, 584, 680 },
        ...
        { 72, 40, 0, 0, 27334, 656, 32 },
        { 72, 40, 45, 0, 25459, 656, 32 },
        { 72, 40, 90, 23584, 23584, 656, 32 },
        { 72, 40, 135, 21709, 21709, 656, 32 },
        ...
        { 90, 40, 0, 0, 28084, 674, 50 },
        { 90, 40, 45, 0, 26209, 674, 50 },
        { 90, 40, 90, 24334, 24334, 674, 50 },
        { 90, 40, 135, 22459, 22459, 674, 50 },
        ...
        { 144, 40, 0, 333, 333, 8, 104 },
        { 144, 40, 45, 0, 28459, 8, 104 },
        { 144, 40, 90, 0, 26584, 8, 104 },
        { 144, 40, 135, 0, 24709, 8, 104 },
        { 144, 40, 180, 22834, 22834, 8, 104 },
        ...
        { 180, -40, 215, 26209, 26209, 124, 220 },
        ...
        { 180, 40, 0, 1833, 1833, 44, 140 },
        { 180, 40, 45, 0, 29959, 44, 140 },
        { 180, 40, 90, 0, 28084, 44, 140 },
        { 180, 40, 135, 0, 26209, 44, 140 },
        { 180, 40, 180, 24334, 24334, 44, 140 },
        ...
        { 270, 40, 45, 3708, 3708, 134, 230 },
        { 270, 40, 90, 1833, 1833, 134, 230 },
        { 270, 40, 135, 0, 29959, 134, 230 },
        { 270, 40, 180, 0, 28084, 134, 230 },
        { 270, 40, 215, 0, 26625, 134, 230 },
        { 270, 40, 270, 24334, 24334, 134, 230 },
        { 270, 40, 315, 22459, 22459, 134, 230 },
        ...
        { 360, 40, 180, 1833, 1833, 224, 320 },
        { 360, 40, 215, 375, 375, 224, 320 },
        { 360, 40, 270, 0, 28084, 224, 320 },
        { 360, 40, 315, 0, 26209, 224, 320 },
        { 360, 40, 360, 24334, 24334, 224, 320 },
        ...
        { 432, 40, 315, 0, 29209, 296, 392 },
        { 432, 40, 360, 0, 27334, 296, 392 },
