...
static void reset_init_postconditions(void)
{
    ...
    currentStatus.vvt1Duty = 99;
    currentStatus.vvt2Duty = 99;
    currentStatus.vvt1Angle = 99;
    currentStatus.vvt2Angle = 99;
...
static void assert_init_postconditions(void)
{
    ...
    TEST_ASSERT_EQUAL(0, currentStatus.vvt1Duty);
    TEST_ASSERT_EQUAL(0, currentStatus.vvt2Duty);
    TEST_ASSERT_EQUAL(0, currentStatus.vvt1Angle);
    TEST_ASSERT_EQUAL(0, currentStatus.vvt2Angle);
    TEST_ASSERT_FALSE(currentStatus.vvt1AngleError);
    TEST_ASSERT_FALSE(currentStatus.vvt2AngleError);
