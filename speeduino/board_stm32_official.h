...
static void FUEL1_TIMER_ENABLE() { (TIM3)->CR1 |= TIM_CR1_CEN; (TIM3)->SR = ~TIM_FLAG_CC1; (TIM3)->DIER |= TIM_DIER_CC1IE; }
static void FUEL2_TIMER_ENABLE() { (TIM3)->CR1 |= TIM_CR1_CEN; (TIM3)->SR = ~TIM_FLAG_CC2; (TIM3)->DIER |= TIM_DIER_CC2IE; }
static void FUEL3_TIMER_ENABLE() { (TIM3)->CR1 |= TIM_CR1_CEN; (TIM3)->SR = ~TIM_FLAG_CC3; (TIM3)->DIER |= TIM_DIER_CC3IE; }
static void FUEL4_TIMER_ENABLE() { (TIM3)->CR1 |= TIM_CR1_CEN; (TIM3)->SR = ~TIM_FLAG_CC4; (TIM3)->DIER |= TIM_DIER_CC4IE; }

static void FUEL1_TIMER_DISABLE() { (TIM3)->DIER &= ~TIM_DIER_CC1IE; }
static void FUEL2_TIMER_DISABLE() { (TIM3)->DIER &= ~TIM_DIER_CC2IE; }
static void FUEL3_TIMER_DISABLE() { (TIM3)->DIER &= ~TIM_DIER_CC3IE; }
static void FUEL4_TIMER_DISABLE() { (TIM3)->DIER &= ~TIM_DIER_CC4IE; }

static void IGN1_TIMER_ENABLE() { (TIM2)->CR1 |= TIM_CR1_CEN; (TIM2)->SR = ~TIM_FLAG_CC1; (TIM2)->DIER |= TIM_DIER_CC1IE; }
static void IGN2_TIMER_ENABLE() { (TIM2)->CR1 |= TIM_CR1_CEN; (TIM2)->SR = ~TIM_FLAG_CC2; (TIM2)->DIER |= TIM_DIER_CC2IE; }
static void IGN3_TIMER_ENABLE() { (TIM2)->CR1 |= TIM_CR1_CEN; (TIM2)->SR = ~TIM_FLAG_CC3; (TIM2)->DIER |= TIM_DIER_CC3IE; }
static void IGN4_TIMER_ENABLE() { (TIM2)->CR1 |= TIM_CR1_CEN; (TIM2)->SR = ~TIM_FLAG_CC4; (TIM2)->DIER |= TIM_DIER_CC4IE; }

static void IGN1_TIMER_DISABLE() { (TIM2)->DIER &= ~TIM_DIER_CC1IE; }
static void IGN2_TIMER_DISABLE() { (TIM2)->DIER &= ~TIM_DIER_CC2IE; }
static void IGN3_TIMER_DISABLE() { (TIM2)->DIER &= ~TIM_DIER_CC3IE; }
static void IGN4_TIMER_DISABLE() { (TIM2)->DIER &= ~TIM_DIER_CC4IE; }



#ifdef TIM5
static void FUEL5_TIMER_ENABLE() { (TIM5)->CR1 |= TIM_CR1_CEN; (TIM5)->CR1 |= TIM_CR1_CEN; (TIM5)->SR = ~TIM_FLAG_CC1; (TIM5)->DIER |= TIM_DIER_CC1IE; }
static void FUEL6_TIMER_ENABLE() { (TIM5)->CR1 |= TIM_CR1_CEN; (TIM5)->CR1 |= TIM_CR1_CEN; (TIM5)->SR = ~TIM_FLAG_CC2; (TIM5)->DIER |= TIM_DIER_CC2IE; }
static void FUEL7_TIMER_ENABLE() { (TIM5)->CR1 |= TIM_CR1_CEN; (TIM5)->CR1 |= TIM_CR1_CEN; (TIM5)->SR = ~TIM_FLAG_CC3; (TIM5)->DIER |= TIM_DIER_CC3IE; }
static void FUEL8_TIMER_ENABLE() { (TIM5)->CR1 |= TIM_CR1_CEN; (TIM5)->CR1 |= TIM_CR1_CEN; (TIM5)->SR = ~TIM_FLAG_CC4; (TIM5)->DIER |= TIM_DIER_CC4IE; }

static void FUEL5_TIMER_DISABLE() { (TIM5)->DIER &= ~TIM_DIER_CC1IE; }
static void FUEL6_TIMER_DISABLE() { (TIM5)->DIER &= ~TIM_DIER_CC2IE; }
static void FUEL7_TIMER_DISABLE() { (TIM5)->DIER &= ~TIM_DIER_CC3IE; }
static void FUEL8_TIMER_DISABLE() { (TIM5)->DIER &= ~TIM_DIER_CC4IE; }
#endif

static void IGN5_TIMER_ENABLE() { (TIM4)->CR1 |= TIM_CR1_CEN; (TIM4)->SR = ~TIM_FLAG_CC1; (TIM4)->DIER |= TIM_DIER_CC1IE; }
static void IGN6_TIMER_ENABLE() { (TIM4)->CR1 |= TIM_CR1_CEN; (TIM4)->SR = ~TIM_FLAG_CC2; (TIM4)->DIER |= TIM_DIER_CC2IE; }
static void IGN7_TIMER_ENABLE() { (TIM4)->CR1 |= TIM_CR1_CEN; (TIM4)->SR = ~TIM_FLAG_CC3; (TIM4)->DIER |= TIM_DIER_CC3IE; }
static void IGN8_TIMER_ENABLE() { (TIM4)->CR1 |= TIM_CR1_CEN; (TIM4)->SR = ~TIM_FLAG_CC4; (TIM4)->DIER |= TIM_DIER_CC4IE; }

static void IGN5_TIMER_DISABLE() { (TIM4)->DIER &= ~TIM_DIER_CC1IE; }
static void IGN6_TIMER_DISABLE() { (TIM4)->DIER &= ~TIM_DIER_CC2IE; }
static void IGN7_TIMER_DISABLE() { (TIM4)->DIER &= ~TIM_DIER_CC3IE; }
static void IGN8_TIMER_DISABLE() { (TIM4)->DIER &= ~TIM_DIER_CC4IE; }
