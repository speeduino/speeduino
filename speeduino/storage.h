...
#define EEPROM_CONFIG6_END    1269
#define EEPROM_CONFIG7_XSIZE1 1269
#define EEPROM_CONFIG7_YSIZE1 1270
#define EEPROM_CONFIG7_MAP1   1271
#define EEPROM_CONFIG7_XBINS1 1335
#define EEPROM_CONFIG7_YBINS1 1343
#define EEPROM_CONFIG7_XSIZE2 1351
#define EEPROM_CONFIG7_YSIZE2 1352
#define EEPROM_CONFIG7_MAP2   1353
#define EEPROM_CONFIG7_XBINS2 1417
#define EEPROM_CONFIG7_YBINS2 1425

#define EEPROM_CONFIG7_XSIZE3 1433
#define EEPROM_CONFIG7_YSIZE3 1434
#define EEPROM_CONFIG7_MAP3   1435

#define EEPROM_CONFIG7_XBINS3 1499
#define EEPROM_CONFIG7_YBINS3 1507
#define EEPROM_CONFIG7_END    1515
#define EEPROM_CONFIG8_XSIZE1 1515
#define EEPROM_CONFIG8_YSIZE1 1516
#define EEPROM_CONFIG8_MAP1   1517
#define EEPROM_CONFIG8_XBINS1 1553
#define EEPROM_CONFIG8_YBINS1 1567
#define EEPROM_CONFIG8_XSIZE2 1565
#define EEPROM_CONFIG8_YSIZE2 1566
#define EEPROM_CONFIG8_MAP2   1567
#define EEPROM_CONFIG8_XBINS2 1603
#define EEPROM_CONFIG8_YBINS2 1617
#define EEPROM_CONFIG8_XSIZE3 1615
#define EEPROM_CONFIG8_YSIZE3 1616
#define EEPROM_CONFIG8_MAP3   1617
#define EEPROM_CONFIG8_XBINS3 1653
#define EEPROM_CONFIG8_YBINS3 1659
#define EEPROM_CONFIG8_XSIZE4 1665
#define EEPROM_CONFIG8_YSIZE4 1666
#define EEPROM_CONFIG8_MAP4   1667
#define EEPROM_CONFIG8_XBINS4 1703
#define EEPROM_CONFIG8_YBINS4 1709
#define EEPROM_CONFIG9_START 1724
#define EEPROM_CONFIG9_END   1916
#define EEPROM_CONFIG10_START 1916
#define EEPROM_CONFIG10_END   2108
