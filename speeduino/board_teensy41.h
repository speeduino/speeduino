...
*/
  ...
  #define ENABLE_FAN_TIMER()    TMR3_CSCTRL0 |= TMR_CSCTRL_TCF3EN
  #define DISABLE_FAN_TIMER()   TMR3_CSCTRL0 |= TMR_CSCTRL_TCF3EN
  ...
  #define FAN_TIMER_COMPARE     TMR3_COMP30
  #define FAN_TIMER_COUNTER     TMR3_CNTR0
