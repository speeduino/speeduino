...
*/
  ...
  */
  ...
  #define KNK1_COUNTER FLEXPWM1_SM0CNT
  #define KNK2_COUNTER FLEXPWM1_SM1CNT
  #define KNK3_COUNTER FLEXPWM1_SM2CNT
  #define KNK4_COUNTER FLEXPWM1_SM3CNT
  #define KNK5_COUNTER FLEXPWM2_SM0CNT
  #define KNK6_COUNTER FLEXPWM2_SM1CNT
  #define KNK7_COUNTER FLEXPWM2_SM2CNT
  #define KNK8_COUNTER FLEXPWM2_SM3CNT
  ...
  #define KNK1_COMPARE FLEXPWM1_SM0VAL1
  #define KNK2_COMPARE FLEXPWM1_SM1VAL1
  #define KNK3_COMPARE FLEXPWM1_SM2VAL1
  #define KNK4_COMPARE FLEXPWM1_SM3VAL1
  #define KNK5_COMPARE FLEXPWM2_SM0VAL1
  #define KNK6_COMPARE FLEXPWM2_SM1VAL1
  #define KNK7_COMPARE FLEXPWM2_SM2VAL1
  #define KNK8_COMPARE FLEXPWM2_SM3VAL1
  ...
  #define KNK1_TIMER_ENABLE() FLEXPWM1_SM0INTEN |= FLEXPWM_SMINTEN_CMPIE(1<<0)
  #define KNK2_TIMER_ENABLE() FLEXPWM1_SM1INTEN |= FLEXPWM_SMINTEN_CMPIE(1<<1)
  #define KNK3_TIMER_ENABLE() FLEXPWM1_SM2INTEN |= FLEXPWM_SMINTEN_CMPIE(1<<2)
  #define KNK4_TIMER_ENABLE() FLEXPWM1_SM3INTEN |= FLEXPWM_SMINTEN_CMPIE(1<<3)
  #define KNK5_TIMER_ENABLE() FLEXPWM2_SM0INTEN |= FLEXPWM_SMINTEN_CMPIE(1<<0)
  #define KNK6_TIMER_ENABLE() FLEXPWM2_SM1INTEN |= FLEXPWM_SMINTEN_CMPIE(1<<1)
  #define KNK7_TIMER_ENABLE() FLEXPWM2_SM2INTEN |= FLEXPWM_SMINTEN_CMPIE(1<<2)
  #define KNK8_TIMER_ENABLE() FLEXPWM2_SM3INTEN |= FLEXPWM_SMINTEN_CMPIE(1<<3)
          
  #define KNK1_TIMER_DISABLE() FLEXPWM1_SM0INTEN &= ~FLEXPWM_SMINTEN_CMPIE(1<<0)
  #define KNK2_TIMER_DISABLE() FLEXPWM1_SM1INTEN &= ~FLEXPWM_SMINTEN_CMPIE(1<<1)
  #define KNK3_TIMER_DISABLE() FLEXPWM1_SM2INTEN &= ~FLEXPWM_SMINTEN_CMPIE(1<<2)
  #define KNK4_TIMER_DISABLE() FLEXPWM1_SM3INTEN &= ~FLEXPWM_SMINTEN_CMPIE(1<<3)
  #define KNK5_TIMER_DISABLE() FLEXPWM2_SM0INTEN &= ~FLEXPWM_SMINTEN_CMPIE(1<<0)
  #define KNK6_TIMER_DISABLE() FLEXPWM2_SM1INTEN &= ~FLEXPWM_SMINTEN_CMPIE(1<<1)
  #define KNK7_TIMER_DISABLE() FLEXPWM2_SM2INTEN &= ~FLEXPWM_SMINTEN_CMPIE(1<<2)
  #define KNK8_TIMER_DISABLE() FLEXPWM2_SM3INTEN &= ~FLEXPWM_SMINTEN_CMPIE(1<<3)

  #define KNK1_COMPARE_UPDATE_ENA() FLEXPWM1_MCTRL |= FLEXPWM_MCTRL_CLDOK(1<<0) // These need to be called before SET_COMPARE
  #define KNK2_COMPARE_UPDATE_ENA() FLEXPWM1_MCTRL |= FLEXPWM_MCTRL_CLDOK(1<<1)
  #define KNK3_COMPARE_UPDATE_ENA() FLEXPWM1_MCTRL |= FLEXPWM_MCTRL_CLDOK(1<<2)
  #define KNK4_COMPARE_UPDATE_ENA() FLEXPWM1_MCTRL |= FLEXPWM_MCTRL_CLDOK(1<<3)
  #define KNK5_COMPARE_UPDATE_ENA() FLEXPWM2_MCTRL |= FLEXPWM_MCTRL_CLDOK(1<<0)
  #define KNK6_COMPARE_UPDATE_ENA() FLEXPWM2_MCTRL |= FLEXPWM_MCTRL_CLDOK(1<<1)
  #define KNK7_COMPARE_UPDATE_ENA() FLEXPWM2_MCTRL |= FLEXPWM_MCTRL_CLDOK(1<<2)
  #define KNK8_COMPARE_UPDATE_ENA() FLEXPWM2_MCTRL |= FLEXPWM_MCTRL_CLDOK(1<<3)
    
  #define KNK1_COMPARE_UPDATE_DIS() FLEXPWM1_MCTRL |= FLEXPWM_MCTRL_LDOK(1<<0) // These need to be called after SET_COMPARE
  #define KNK2_COMPARE_UPDATE_DIS() FLEXPWM1_MCTRL |= FLEXPWM_MCTRL_LDOK(1<<1)
  #define KNK3_COMPARE_UPDATE_DIS() FLEXPWM1_MCTRL |= FLEXPWM_MCTRL_LDOK(1<<2)
  #define KNK4_COMPARE_UPDATE_DIS() FLEXPWM1_MCTRL |= FLEXPWM_MCTRL_LDOK(1<<3)
  #define KNK5_COMPARE_UPDATE_DIS() FLEXPWM2_MCTRL |= FLEXPWM_MCTRL_LDOK(1<<0)
  #define KNK6_COMPARE_UPDATE_DIS() FLEXPWM2_MCTRL |= FLEXPWM_MCTRL_LDOK(1<<1)
  #define KNK7_COMPARE_UPDATE_DIS() FLEXPWM2_MCTRL |= FLEXPWM_MCTRL_LDOK(1<<2)
  #define KNK8_COMPARE_UPDATE_DIS() FLEXPWM2_MCTRL |= FLEXPWM_MCTRL_LDOK(1<<3)
