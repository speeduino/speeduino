...
void triggerSetup_missingTooth()
{
  ...
  triggerSecFilterTime = (int)((configPage2.trigPatternSec == SEC_TRIGGER_4_1 ) ? 1000000 * 60 / MAX_RPM / 4 / 2 : 1000000 * 60 / MAX_RPM / 2 / 2); //For 4-1 came wheel. Same as above, but fixed at 2 teeth on the secondary input and divided by 2 (for cam speed)
...
void triggerSec_missingTooth()
{
  ...
  {
    if ( configPage2.trigPatternSec == SEC_TRIGGER_4_1 )
    {
