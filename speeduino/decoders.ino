...
static inline void checkPerToothTiming(int16_t crankAngle, uint16_t currentTooth)
{
  if (currentStatus.RPM > 0)
  {
    ...
    {
      if( (ignitionSchedule1.Status == RUNNING) ) {setIgnition1Compare ( IGN1_COUNTER + uS_TO_TIMER_COMPARE( fastDegreesToUS( ignitionLimits( (ignition1EndAngle - crankAngle) ) ) )); }
    ...
    {
      if( (ignitionSchedule2.Status == RUNNING) ) { setIgnition2Compare (IGN2_COUNTER + uS_TO_TIMER_COMPARE( fastDegreesToUS( ignitionLimits( (ignition2EndAngle - crankAngle) ) ) )); }
    ...
    else if ( (currentTooth == ignition3EndTooth) )
    {
      ...
      if( (ignitionSchedule3.Status == RUNNING) ) {setIgnition3Compare( IGN3_COUNTER + uS_TO_TIMER_COMPARE( fastDegreesToUS( ignitionLimits( (ignition3EndAngle - crankAngle) ) ) )); }
    ...
    {
      if( (ignitionSchedule4.Status == RUNNING) ) { setIgnition4Compare( IGN4_COUNTER + uS_TO_TIMER_COMPARE( fastDegreesToUS( ignitionLimits( (ignition4EndAngle - crankAngle) ) ) )); }
    ...
    {
      if( (ignitionSchedule5.Status == RUNNING) ) { setIgnition5Compare(IGN5_COUNTER + uS_TO_TIMER_COMPARE( fastDegreesToUS( ignitionLimits( (ignition5EndAngle - crankAngle) ) ) )); }
    ...
    {
      if( (ignitionSchedule6.Status == RUNNING) ) {setIgnition6Compare( IGN6_COUNTER + uS_TO_TIMER_COMPARE( fastDegreesToUS( ignitionLimits( (ignition6EndAngle - crankAngle) ) ) )); }
    ...
    {
      if( (ignitionSchedule7.Status == RUNNING) ) { setIgnition7Compare( IGN7_COUNTER + uS_TO_TIMER_COMPARE( fastDegreesToUS( ignitionLimits( (ignition7EndAngle - crankAngle) ) ) )); }
    ...
    {
      if( (ignitionSchedule8.Status == RUNNING) ) { setIgnition8Compare( IGN8_COUNTER + uS_TO_TIMER_COMPARE( fastDegreesToUS( ignitionLimits( (ignition8EndAngle - crankAngle) ) ) )); }
