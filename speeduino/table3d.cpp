...
table_axis_iterator x_begin(void *pTable, table_type_t key)
{
  ...
  #define CTA_GET_X_ITERATOR_DEFAULT ({ return table_axis_iterator(NULL, NULL, axis_domain_Rpm); })      
...
table_axis_iterator y_begin(void *pTable, table_type_t key)
{
  ...
  #define CTA_GET_Y_ITERATOR_DEFAULT ({ return table_axis_iterator(NULL, NULL, axis_domain_Rpm); })      
