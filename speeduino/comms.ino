...
void updateFullStatus()
{
  ...
  fullStatus[93] = lowByte((int16_t)currentStatus.vvt1Angle); //cam angle needs to be casted as int16, because it can have values from -360 to 360
  fullStatus[94] = highByte((int16_t)currentStatus.vvt1Angle);
  ...
  fullStatus[108] = currentStatus.wmiEmpty;
  fullStatus[109] = lowByte((int16_t)currentStatus.vvt2Angle);  //cam angle needs to be casted as int16, because it can have values from -360 to 360
  fullStatus[110] = highByte((int16_t)currentStatus.vvt2Angle);
  fullStatus[111] = currentStatus.vvt2TargetAngle;
  fullStatus[112] = currentStatus.vvt2Duty;
