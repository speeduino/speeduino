...
void loop()
{
    ...
    if (BIT_CHECK(LOOP_TIMER, BIT_TIMER_15HZ)) //Every 32 loops
    {
      ...
      if (configPage6.launchEnabled && clutchTrigger && (currentStatus.clutchEngagedRPM < ((unsigned int)(configPage6.flatSArm) * 100)) && (currentStatus.RPM > currentStatus.VARlaunch) && (currentStatus.TPS >= configPage10.lnchCtrlTPS) )
      { 
    ...
    if (BIT_CHECK(LOOP_TIMER, BIT_TIMER_4HZ))
    {
      ...
      readVARlaunch(); //VARlaunch reading
