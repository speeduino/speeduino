...
void setPinMapping(byte boardID)
{
  ...
  if ( (configPage9.oilSensorOPStPin != 0) && (configPage9.oilSensorOPStPin < BOARD_MAX_IO_PINS)) { pinOilSensorOPSt = configPage9.oilSensorOPStPin; }
...
// #endif
  ...
  if( (configPage10.oilPressureEnable == 1) && (!pinIsOutput(pinOilPressure)) )
  {
    pinMode(pinOilPressure, INPUT);
  } 
  else if (configPage10.oilPressureEnable == 2 && (!pinIsOutput(pinOilPressure)) )
  {
