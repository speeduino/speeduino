...
void setPinMapping(byte boardID)
{
  ...
  if ( (configPage6.launchEnabled) && (configPage9.VarLaunchPin < BOARD_MAX_IO_PINS) ) { pinVarLaunch = pinTranslateAnalog(configPage9.VarLaunchPin); } //fera launch
