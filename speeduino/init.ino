...
void setPinMapping(byte boardID)
{
  ...
  switch (boardID)
  {
   ...
   case 31:
    ...
    #if defined(CORE_TEENSY35)
    case 53:
      //Pin mappings for JuiceBox
      pinInjector1 = 1; //Output pin injector 1 is on
      pinInjector2 = 2; //Output pin injector 2 is on
      pinInjector3 = 5; //Output pin injector 3 is on
      pinInjector4 = 6; //Output pin injector 4 is on
      pinCoil1 = 29; //Pin for coil 1
      pinCoil2 = 30; //Pin for coil 2
      pinCoil3 = 31; //Pin for coil 3
      pinCoil4 = 32; //Pin for coil 4
      pinTrigger = 37; //The CAS pin
      pinTrigger2 = 38; //The Cam Sensor pin
      pinTPS = A2; //TPS input pin
      ...
      pinStepperStep = 23; //Step pin for DRV8825 driver
      pinStepperEnable = 39; //Enable pin for DRV8825 driver
      pinLaunch = 26; //Can be overwritten below
      pinFan = 25; //Pin for the fan output
      pinSpareHOut1 = 26; // high current output spare1
      pinSpareHOut2 = 27; // high current output spare2
      pinSpareLOut1 = 0; //low current output spare1
      break;
    #endif
