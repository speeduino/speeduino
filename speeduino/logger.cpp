...
byte getTSLogEntry(uint16_t byteNum)
{
  ...
  switch(byteNum)
  {
    ...
    case 74: statusValue = lowByte(currentStatus.tpsADC); break;
    case 75: statusValue = highByte(currentStatus.tpsADC); break;
    case 76: statusValue = 0U /*getNextError()*/; break;

    case 77: statusValue = lowByte(currentStatus.PW1); break;
    case 78: statusValue = highByte(currentStatus.PW1); break;
    case 79: statusValue = lowByte(currentStatus.PW2); break;
    case 80: statusValue = highByte(currentStatus.PW2); break;
    case 81: statusValue = lowByte(currentStatus.PW3); break;
    case 82: statusValue = highByte(currentStatus.PW3); break;
    case 83: statusValue = lowByte(currentStatus.PW4); break;
    case 84: statusValue = highByte(currentStatus.PW4); break;

    case 85: statusValue = currentStatus.status3; break;
    case 86: statusValue = currentStatus.engineProtectStatus; break;
    case 87: statusValue = lowByte(currentStatus.fuelLoad); break;
    case 88: statusValue = highByte(currentStatus.fuelLoad); break;
    case 89: statusValue = lowByte(currentStatus.ignLoad); break;
    case 90: statusValue = highByte(currentStatus.ignLoad); break;
    case 91: statusValue = lowByte(currentStatus.dwell); break;
    case 92: statusValue = highByte(currentStatus.dwell); break;
    case 93: statusValue = currentStatus.CLIdleTarget; break;
    case 94: statusValue = lowByte(currentStatus.mapDOT); break;
    case 95: statusValue = highByte(currentStatus.mapDOT); break;
    case 96: statusValue = lowByte(currentStatus.vvt1Angle); break; //2 bytes for vvt1Angle
    case 97: statusValue = highByte(currentStatus.vvt1Angle); break;
    case 98: statusValue = currentStatus.vvt1TargetAngle; break;
    case 99: statusValue = lowByte(currentStatus.vvt1Duty); break;
    case 100: statusValue = lowByte(currentStatus.flexBoostCorrection); break;
    case 101: statusValue = highByte(currentStatus.flexBoostCorrection); break;
    case 102: statusValue = currentStatus.baroCorrection; break;
    case 103: statusValue = currentStatus.VE; break; //Current VE (%). Can be equal to VE1 or VE2 or a calculated value from both of them
    case 104: statusValue = currentStatus.ASEValue; break; //Current ASE (%)
    case 105: statusValue = lowByte(currentStatus.vss); break;
    case 106: statusValue = highByte(currentStatus.vss); break;
    case 107: statusValue = currentStatus.gear; break;
    case 108: statusValue = currentStatus.fuelPressure; break;
    case 109: statusValue = currentStatus.oilPressure; break;
    case 110: statusValue = currentStatus.wmiPW; break;
    case 111: statusValue = currentStatus.status4; break;
    case 112: statusValue = lowByte(currentStatus.vvt2Angle); break; //2 bytes for vvt2Angle
    case 113: statusValue = highByte(currentStatus.vvt2Angle); break;
    case 114: statusValue = currentStatus.vvt2TargetAngle; break;
    case 115: statusValue = lowByte(currentStatus.vvt2Duty); break;
    case 116: statusValue = currentStatus.outputsStatus; break;
    case 117: statusValue = lowByte(temperatureAddOffset(currentStatus.fuelTemp)); break; //Fuel temperature from flex sensor
    case 118: statusValue = currentStatus.fuelTempCorrection; break; //Fuel temperature Correction (%)
    case 119: statusValue = currentStatus.advance1; break; //advance 1 (%)
    case 120: statusValue = currentStatus.advance2; break; //advance 2 (%)
    case 121: statusValue = currentStatus.TS_SD_Status; break; //SD card status
    case 122: statusValue = lowByte(currentStatus.EMAP); break; //2 bytes for EMAP
    case 123: statusValue = highByte(currentStatus.EMAP); break;
    case 124: statusValue = currentStatus.fanDuty; break;
    case 125: statusValue = currentStatus.airConStatus; break;
    case 126: statusValue = lowByte(currentStatus.actualDwell); break;
    case 127: statusValue = highByte(currentStatus.actualDwell); break;
    case 128: statusValue = currentStatus.status5; break;
    case 129: statusValue = currentStatus.knockCount; break;
    case 130: statusValue = currentStatus.knockRetard; break;

    case 131: statusValue = lowByte(currentStatus.PW5); break;
    case 132: statusValue = highByte(currentStatus.PW5); break;
    case 133: statusValue = lowByte(currentStatus.PW6); break;
    case 134: statusValue = highByte(currentStatus.PW6); break;
    case 135: statusValue = lowByte(currentStatus.PW7); break;
    case 136: statusValue = highByte(currentStatus.PW7); break;
    case 137: statusValue = lowByte(currentStatus.PW8); break;
    case 138: statusValue = highByte(currentStatus.PW8); break;

    case 139: statusValue = currentStatus.systemTemp; break;
