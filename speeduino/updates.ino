...
void doUpdates(void)
{
  ...
  if(readEEPROMVersion() == 10)
  {
    ...
    configPage15.asePct2[0] = configPage2.aeColdTaperMin;
    configPage15.asePct2[1] = configPage2.aeColdTaperMin;
    configPage15.asePct2[2] = configPage2.aeColdTaperMin;
    configPage15.asePct2[3] = configPage2.aeColdTaperMin;
