...
#define DSR_NO_SYNC       0 // No sync
#define DSR_CYLINDER      1 // Per cylinder, normally basic distributor / degrees varies depending on cylinder count, 144 for 5 cylinder (720/5) (not in use)
#define DSR_REVOLUTION    2 // Per crankshaft revolution / 360 degrees
#define DSR_4STROKE_CYCLE 3 // Per 4-stroke cycle / 720 degrees
#define DSR_WANKEL_CYCLE  4 // Per wankel cycle / 1080 degrees (not in use)
extern volatile byte decoderSyncedResolution;
