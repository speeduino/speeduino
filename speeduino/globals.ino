...
const uint16_t npage_size[NUM_PAGES] = {0,128,288,288,128,288,128,240,192,192,192,288,100}; /**< This array stores the size (in bytes) of each configuration page */
