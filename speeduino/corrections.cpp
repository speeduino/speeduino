...
uint16_t correctionsDwell(uint16_t dwell)
{
  ...
  */
  ...
  if(dwellPerRevolution > revolutionTime)
  {
    ...
    uint16_t adjustedSparkDur = fast_div32_16(sparkDur_uS * revolutionTime, dwellPerRevolution);
    tempDwell = fast_div32_16(revolutionTime, (uint16_t)pulsesPerRevolution) - adjustedSparkDur;
  }
