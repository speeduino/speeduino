...
byte getGear()
{
  ...
  if(currentStatus.vss > 0)
  {
    ...
    if     ( (pulsesPer1000rpm > 0)                       && (pulsesPer1000rpm <= (configPage2.vssRatio1)) ) { tempGear = 1; }
    else if( (pulsesPer1000rpm > (configPage2.vssRatio1)) && (pulsesPer1000rpm <= (configPage2.vssRatio2)) ) { tempGear = 2; }
    else if( (pulsesPer1000rpm > (configPage2.vssRatio2)) && (pulsesPer1000rpm <= (configPage2.vssRatio3)) ) { tempGear = 3; }
    else if( (pulsesPer1000rpm > (configPage2.vssRatio3)) && (pulsesPer1000rpm <= (configPage2.vssRatio4)) ) { tempGear = 4; }
    else if( (pulsesPer1000rpm > (configPage2.vssRatio4)) && (pulsesPer1000rpm <= (configPage2.vssRatio5)) ) { tempGear = 5; }
    else if( (pulsesPer1000rpm > (configPage2.vssRatio5)) && (pulsesPer1000rpm <= (configPage2.vssRatio6)) ) { tempGear = 6; }
  }
