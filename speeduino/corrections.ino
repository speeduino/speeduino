...
int8_t correctionSoftLaunch(int8_t advance)
{
  ...
  //SoftCut rev limit for 2-step launch control.
   if (configPage6.launchEnabled && clutchTrigger && (currentStatus.clutchEngagedRPM < ((unsigned int)(configPage6.flatSArm) * 100)) && (currentStatus.RPM > ((currentStatus.VARlaunch)-(unsigned int)(configPage6.lnchSoftLimZone) * 100)) && (currentStatus.TPS >= configPage10.lnchCtrlTPS) )
  {
