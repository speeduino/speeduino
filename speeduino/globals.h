...
#define pinIsOutput(pin)    ( pinIsInjector((pin)) || pinIsIgnition((pin)) || ((pin) == pinFuelPump) || ( ((pin) == pinFan) && configPage2.fanEnable ) || ( ((pin) == pinVVT_1) && configPage6.vvtEnabled ) || ( ((pin) == pinVVT_2) && configPage6.vvtEnabled ) || ( ((pin) == pinBoost) && configPage6.boostEnabled ) || ((pin) == pinIdle1) || ((pin) == pinIdle2) || ((pin) == pinTachOut) || ((pin) == pinStepperEnable) || ((pin) == pinStepperStep) )
