...
#define BIT_STATUS3_HALFSYNC      4 //shows if there is only sync from primary trigger, but not from secondary. Only used for comms/external devices. Firmware use replaced by decoderSync
