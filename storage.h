...
#include <EEPROM.h>
	...
	#include <Wire.h>
	#define EEPROM_ADDR 0x50	//i2c address of the EEPROM chip
#endif
...
#define EEPROM_CONFIG8_XSIZE3 1291
#define EEPROM_CONFIG8_YSIZE3 1295
#define EEPROM_CONFIG8_MAP3		1299
#define EEPROM_CONFIG8_XBINS3	1315
#define EEPROM_CONFIG8_YBINS3	1319
#define EEPROM_CONFIG8_XSIZE4 1323
#define EEPROM_CONFIG8_YSIZE4 1327
#define EEPROM_CONFIG8_MAP4		1331
#define EEPROM_CONFIG8_XBINS4	1347
#define EEPROM_CONFIG8_YBINS4 1351
